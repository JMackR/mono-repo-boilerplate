...
const SaveMedia = async ({ status, currentUserData, media, media_sub_type }) => {
  ...
  if (status === "PUBLISHED") {
    mediaObj.published_date = moment(scheduled_date, "MM/DD/YYYY h:mm A").utc().format()
  } else if (status === "SCHEDULED") {
    mediaObj.scheduled_date = moment(scheduled_date, "MM/DD/YYYY h:mm A").utc().format()
  }
  ...
  //       message: "YR STORY HAS BEEN SAVED AS A DRAFT",
